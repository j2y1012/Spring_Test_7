...
public class FileController {
	...
	public String seUpload(SeFileDTO seFileDTO,HttpSession session) throws Exception{
		...
		String callbac_func = seFileDTO.getCallback_func();
	...
	System.out.println( "redirect:"+callback+"?callback_func="+callbac_func+file_result);
	return "redirect:"+callback+"?callback_func="+callbac_func+file_result;
	}
	public void seUpload(HttpServletRequest request,MultipartFile Filedata){
